...
/*
    ...
    @Before
    public void init() {
        Client book = new Client(1L, "Book Name", "Book Title", new BigDecimal("9.99"));
    ...
    public void find_allBook_OK() throws Exception {
        ...
        List<Client> books = Arrays.asList(
                new Client(1L, "Book A", "Ah Pig", new BigDecimal("1.99")),
                new Client(2L, "Book B", "Ah Dog", new BigDecimal("2.99")));
    ...
    public void save_book_OK() throws Exception {
        ...
        Client newBook = new Client(1L, "Book Name", "Book Title", new BigDecimal("2.99"));

        when(mockRepository.save(any(Client.class))).thenReturn(newBook);
    ...
    public void update_book_OK() throws Exception {
        ...
        Client updateBook = new Client(1L, "Book Name", "Book Title", new BigDecimal("2.99"));
        when(mockRepository.save(any(Client.class))).thenReturn(updateBook);
    ...
    public void patch_bookAuthor_OK() {
        ...
        when(mockRepository.save(any(Client.class))).thenReturn(new Client());
    ...
    public void patch_bookPrice_405() throws JSONException {
        ...
        verify(mockRepository, times(1)).findById(1L);
        verify(mockRepository, times(0)).save(any(Client.class));
    }
